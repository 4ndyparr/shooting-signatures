...
And that's pretty much it! Try rendering your own signatures opening the notebook with **mybinder**. https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/4ndyparr/shooting-signatures/master)
